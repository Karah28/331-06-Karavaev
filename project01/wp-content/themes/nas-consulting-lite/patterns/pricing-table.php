...
/**
 * Title: Pricing Table 
 * Slug: nas-consulting-lite/pricing-table
...
$nusacons_consulting_images = array(
    $nusacons_consulting_url . 'assets/images/check_circle.png',
);
?>
...
<div class="wp-block-group has-light-color-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:70px;padding-right:var(--wp--preset--spacing--40);padding-bottom:120px;padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20"}},"className":"nas-consulting-lite-flip-up","layout":{"type":"constrained","contentSize":"640px"}} -->
    <div class="wp-block-group nas-consulting-lite-flip-up"><!-- wp:heading {"textAlign":"center","level":1,"style":{"spacing":{"margin":{"bottom":"24px","top":"16px"}}}} -->
        <h1 class="wp-block-heading has-text-align-center" style="margin-top:16px;margin-bottom:24px"><?php esc_html_e('Pricing &amp; Plans', 'nas-consulting-lite') ?></h1>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"align":"center"} -->
        <p class="has-text-align-center"><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'nas-consulting-lite') ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->

    <!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"32px"},"margin":{"top":"60px"}}}} -->
    <div class="wp-block-columns" style="margin-top:60px"><!-- wp:column {"className":"nas-consulting-lite-fade-up"} -->
        <div class="wp-block-column nas-consulting-lite-fade-up"><!-- wp:group {"style":{"border":{"radius":"0px","width":"1px","color":"#f1ece6"},"spacing":{"padding":{"top":"40px","bottom":"40px","left":"40px","right":"40px"}}},"backgroundColor":"light-color","className":"nas-consulting-lite-hover-zoom is-style-nas-consulting-lite-boxshadow-medium","layout":{"type":"constrained"}} -->
            <div class="wp-block-group nas-consulting-lite-hover-zoom is-style-nas-consulting-lite-boxshadow-medium has-border-color has-light-color-background-color has-background" style="border-color:#f1ece6;border-width:1px;border-radius:0px;padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px"><!-- wp:heading {"level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|30"}}},"fontSize":"medium"} -->
                <h4 class="wp-block-heading has-medium-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--30);font-style:normal;font-weight:500"><?php esc_html_e('Basic', 'nas-consulting-lite') ?></h4>
                <!-- /wp:heading -->

                <!-- wp:paragraph -->
                <p><?php esc_html_e('Intuitive world-class Support tools For growing teams and agency', 'nas-consulting-lite') ?></p>
                <!-- /wp:paragraph -->
                ...
                <div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--border-light-color);border-bottom-width:1px;padding-bottom:24px"><!-- wp:heading {"level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1"}},"fontSize":"xx-large"} -->
                    <h1 class="wp-block-heading has-xx-large-font-size" style="font-style:normal;font-weight:600;line-height:1"><?php esc_html_e('$49', 'nas-consulting-lite') ?></h1>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph -->
                    <p><?php esc_html_e('/Year', 'nas-consulting-lite') ?></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
                ...
                <div class="wp-block-group"><!-- wp:group {"style":{"spacing":{"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|30"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
                    <div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:image {"id":2116,"width":"20px","sizeSlug":"full","linkDestination":"none"} -->
                        <figure class="wp-block-image size-full is-resized"><img src="<?php echo esc_url($nusacons_consulting_images[0]) ?>" alt="" class="wp-image-2116" style="width:20px" /></figure>
                        <!-- /wp:image -->

                        <!-- wp:heading {"level":5,"style":{"spacing":{"padding":{"top":"6px"}}},"fontSize":"normal"} -->
                        <h5 class="wp-block-heading has-normal-font-size" style="padding-top:6px"><?php esc_html_e('Live Chat for support', 'nas-consulting-lite') ?></h5>
                        <!-- /wp:heading -->
                    </div>
                    <!-- /wp:group -->
                    ...
                    <div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:image {"id":2116,"width":"20px","sizeSlug":"full","linkDestination":"none"} -->
                        ...
                        <!-- wp:heading {"level":5,"style":{"spacing":{"padding":{"top":"6px"}}},"fontSize":"normal"} -->
                        <h5 class="wp-block-heading has-normal-font-size" style="padding-top:6px"><?php esc_html_e('Ticketing Workflows', 'nas-consulting-lite') ?></h5>
                        <!-- /wp:heading -->
                    </div>
                    <!-- /wp:group -->
                    ...
                    <div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:image {"id":2116,"width":"20px","sizeSlug":"full","linkDestination":"none"} -->
                        ...
                        <!-- wp:heading {"level":5,"style":{"spacing":{"padding":{"top":"6px"}}},"fontSize":"normal"} -->
                        <h5 class="wp-block-heading has-normal-font-size" style="padding-top:6px"><?php esc_html_e('Services Level Agreement Rules', 'nas-consulting-lite') ?></h5>
                        <!-- /wp:heading -->
                    </div>
                    <!-- /wp:group -->
                    ...
                    <div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:image {"id":2116,"width":"20px","sizeSlug":"full","linkDestination":"none"} -->
                        ...
                        <!-- wp:heading {"level":5,"style":{"spacing":{"padding":{"top":"6px"}}},"fontSize":"normal"} -->
                        <h5 class="wp-block-heading has-normal-font-size" style="padding-top:6px"><?php esc_html_e('Role Based Permissions', 'nas-consulting-lite') ?></h5>
                        <!-- /wp:heading -->
                    </div>
                    <!-- /wp:group -->
                    ...
                    <div class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:image {"id":2116,"width":"20px","sizeSlug":"full","linkDestination":"none"} -->
                        ...
                        <!-- wp:heading {"level":5,"style":{"spacing":{"padding":{"top":"6px"}}},"fontSize":"normal"} -->
                        <h5 class="wp-block-heading has-normal-font-size" style="padding-top:6px"><?php esc_html_e('Outcome Reporting', 'nas-consulting-lite') ?></h5>
                        <!-- /wp:heading -->
                    </div>
                    <!-- /wp:group -->
                </div>
        ...
        <!-- wp:column {"className":"nas-consulting-lite-fade-up"} -->
        <div class="wp-block-column nas-consulting-lite-fade-up"><!-- wp:group {"style":{"border":{"radius":"0px","width":"1px","color":"#f1ece6"},"spacing":{"padding":{"top":"40px","bottom":"40px","left":"40px","right":"40px"}}},"backgroundColor":"light-color","className":"nas-consulting-lite-hover-zoom is-style-nas-consulting-lite-boxshadow-medium","layout":{"type":"constrained"}} -->
            <div class="wp-block-group nas-consulting-lite-hover-zoom is-style-nas-consulting-lite-boxshadow-medium has-border-color has-light-color-background-color has-background" style="border-color:#f1ece6;border-width:1px;border-radius:0px;padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px"><!-- wp:heading {"level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|30"}}},"fontSize":"medium"} -->
                <h4 class="wp-block-heading has-medium-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--30);font-style:normal;font-weight:500"><?php esc_html_e('Standard', 'nas-consulting-lite') ?></h4>
                <!-- /wp:heading -->
                ...
                <!-- wp:group {"style":{"spacing":{"blockGap":"0","padding":{"bottom":"24px"}},"border":{"bottom":{"color":"var:preset|color|border-light-color","width":"1px"}}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"bottom"}} -->
                <div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--border-light-color);border-bottom-width:1px;padding-bottom:24px"><!-- wp:heading {"level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1"}},"fontSize":"xx-large"} -->
                    <h1 class="wp-block-heading has-xx-large-font-size" style="font-style:normal;font-weight:600;line-height:1"><?php esc_html_e('$149', 'nas-consulting-lite') ?></h1>
                    <!-- /wp:heading -->
        ...
        <!-- wp:column {"className":"nas-consulting-lite-fade-up"} -->
        <div class="wp-block-column nas-consulting-lite-fade-up"><!-- wp:group {"style":{"border":{"radius":"0px","width":"1px","color":"#f1ece6"},"spacing":{"padding":{"top":"40px","bottom":"40px","left":"40px","right":"40px"}},"elements":{"link":{"color":{"text":"var:preset|color|heading-color"}}}},"backgroundColor":"primary","textColor":"heading-color","className":"nas-consulting-lite-hover-zoom is-style-nas-consulting-lite-boxshadow-medium","layout":{"type":"constrained"}} -->
            <div class="wp-block-group nas-consulting-lite-hover-zoom is-style-nas-consulting-lite-boxshadow-medium has-border-color has-heading-color-color has-primary-background-color has-text-color has-background has-link-color" style="border-color:#f1ece6;border-width:1px;border-radius:0px;padding-top:40px;padding-right:40px;padding-bottom:40px;padding-left:40px"><!-- wp:heading {"level":4,"style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|30"}},"elements":{"link":{"color":{"text":"var:preset|color|heading-color"}}}},"textColor":"heading-color","fontSize":"medium"} -->
                <h4 class="wp-block-heading has-heading-color-color has-text-color has-link-color has-medium-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--30);font-style:normal;font-weight:500"><?php esc_html_e('Entreprises', 'nas-consulting-lite') ?></h4>
                <!-- /wp:heading -->

                <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading-color"}}}},"textColor":"heading-color"} -->
                <p class="has-heading-color-color has-text-color has-link-color"><?php esc_html_e('Intuitive world-class Support tools For growing teams and agency', 'nas-consulting-lite') ?></p>
                <!-- /wp:paragraph -->
                ...
                <div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--heading-color);border-bottom-width:1px;padding-bottom:24px"><!-- wp:heading {"level":1,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":"1"}},"fontSize":"xx-large"} -->
                    <h1 class="wp-block-heading has-xx-large-font-size" style="font-style:normal;font-weight:600;line-height:1"><?php esc_html_e('$449', 'nas-consulting-lite') ?></h1>
                    <!-- /wp:heading -->

                    <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|heading-color"}}}},"textColor":"heading-color"} -->
                    <p class="has-heading-color-color has-text-color has-link-color"><?php esc_html_e('/Year', 'nas-consulting-lite') ?></p>
                    <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
